...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos Ullian:" + devUllian.getConteudosInscritos());
        devUllian.progredir();
        devUllian.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Ullian:" + devUllian.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Ullian:" + devUllian.getConteudosConcluidos());
